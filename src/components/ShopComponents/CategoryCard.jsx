export function CategoryCard({ items, title, bgImgUrl }) {
  return (
    ...
    */
    <div className="w-full sm:w-52 md:w-auto md:flex-1 min-w-45 px-2 overflow-hidden rounded-sm group grow">
      <div className="relative w-full overflow-hidden">
        <img src={bgImgUrl} alt={title} className="w-full object-cover" />
